...
class MyFrame1 ( wx.Frame ):
    ...
    def __init__( self, parent ):
        wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = 'Gestor de Agenda', pos = wx.DefaultPosition, size = wx.Size( 348,309 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
        ...
        self.Bind( wx.EVT_MENU, self.borra, id = self.mBorra.GetId() )
            ...
            if not helpers.valida_dni(str(dlg.GetValue())):
                ...
                if manager.agenda.busca_item_dni(dlg.GetValue()):
                    ...
                    for item in range(self.listaPrincipal.ItemCount):
                        if self.listaPrincipal.GetItem(item, 0) == dlg.GetValue():
